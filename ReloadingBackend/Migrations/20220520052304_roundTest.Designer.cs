...
namespace ReloadingBackend.Migrations
{
    ...
    [Migration("20220520052304_roundTest")]
    partial class roundTest
    {
            ...
            modelBuilder.Entity("ReloadingBackend.Models.Round", b =>
                {
                    ...
                    b.HasOne("ReloadingBackend.Models.RoundTest", "RoundTest")
                        .WithOne("Round")
                        .HasForeignKey("ReloadingBackend.Models.Round", "RoundTestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
